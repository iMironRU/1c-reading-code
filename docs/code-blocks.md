...
|---|---:|---|
| `песочница` | 269 | исполняется в тренажёре — кнопка «Запустить», проверяется гейтом |
| `набросок` | 99 | чистый язык, но пока не исполняется: не хватает контекста или точек с запятой |
| `платформа` | 88 | запросы, клиент-сервер, справочники — тренажёр этого не умеет по замыслу |
...
| [chapters/01_leksika/01-04_komanda_esli.md:217](../chapters/01_leksika/01-04_komanda_esli.md) | `Если Цена > 1000 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-04_komanda_esli.md:271](../chapters/01_leksika/01-04_komanda_esli.md) | `Если Цена > 5000 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-04_komanda_esli.md:320](../chapters/01_leksika/01-04_komanda_esli.md) | `СтоимостьПокупки = 3500` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-04_komanda_esli.md:414](../chapters/01_leksika/01-04_komanda_esli.md) | `Если Возраст < 7 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-04_komanda_esli.md:541](../chapters/01_leksika/01-04_komanda_esli.md) | `СтоимостьПокупки = 200 * 35;        // 7000` | исполняется |
...
| [chapters/01_leksika/01-05_chtenie_koda.md:146](../chapters/01_leksika/01-05_chtenie_koda.md) | `Если СтоимостьПокупки >= 10000 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:240](../chapters/01_leksika/01-05_chtenie_koda.md) | `Скидка = 10  // постоянным клиентам — десять процентов` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:276](../chapters/01_leksika/01-05_chtenie_koda.md) | `ПроцентСкидки = 0  // По правилам — никаких скидок на акцион` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:290](../chapters/01_leksika/01-05_chtenie_koda.md) | `ПроцентСкидки = 0  // Присваиваем ПроцентСкидки значение 0` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:308](../chapters/01_leksika/01-05_chtenie_koda.md) | `// Расчёт стоимости покупки с учётом скидки постоянного клие` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:396](../chapters/01_leksika/01-05_chtenie_koda.md) | `Сумма = 500` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:441](../chapters/01_leksika/01-05_chtenie_koda.md) | `// Цикл с присваиванием значения переменной А` | исполняется |
| [chapters/01_leksika/01-05_chtenie_koda.md:470](../chapters/01_leksika/01-05_chtenie_koda.md) | `Имя = "Анна Петрова"` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-05_chtenie_koda.md:556](../chapters/01_leksika/01-05_chtenie_koda.md) | `А = 10;  // 10 — это магическое число из спецификации, см. д` | исполняется |
...
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:198](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Если Цена >= 1000 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:232](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Если Возраст < 18 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:323](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `СтоимостьПокупки = 3500` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:420](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Цена = 250` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:491](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Цена = 250` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:522](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `А = 5` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:546](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Возраст = 25` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:572](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `ПроцентСкидки = 10;` | исполняется |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:580](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Сумма = 1500` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:614](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `ОстатокРучек = 7` | исполняется — рядом лежит вариант с точками с запятой |
...
| [chapters/02_semantika/02-03_vypolnit_stroku.md:17](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `Сумма = Цена * Количество;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:67](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `А = А + 1;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:104](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `Итог = Цена * Количество - Скидка + Налог;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:162](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `А = 10;` | исполняется |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:267](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `// Расчёт стоимости с учётом скидок и наценки за самовывоз` | исполняется |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:364](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `А = 5;` | исполняется |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:374](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `Х = 100;` | исполняется |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:398](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `Возраст = 25;` | исполняется |
| [chapters/02_semantika/02-03_vypolnit_stroku.md:418](../chapters/02_semantika/02-03_vypolnit_stroku.md) | `СтоимостьПокупки = 6500;` | исполняется |
...
| [chapters/03_struktura/03-01_struktura_programmy.md:52](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если ВозрастКлиента >= 18 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/03_struktura/03-01_struktura_programmy.md:86](../chapters/03_struktura/03-01_struktura_programmy.md) | `ВозрастКлиента = 25;` | исполняется |
| [chapters/03_struktura/03-01_struktura_programmy.md:190](../chapters/03_struktura/03-01_struktura_programmy.md) | `// Данные клиента` | исполняется |
| [chapters/03_struktura/03-01_struktura_programmy.md:282](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если А > 0 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/03_struktura/03-01_struktura_programmy.md:355](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если А > 0 И Б > 0 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/03_struktura/03-01_struktura_programmy.md:431](../chapters/03_struktura/03-01_struktura_programmy.md) | `ТипТовара = "тетрадь";` | исполняется |
...
| [chapters/03_struktura/03-06_blok_shemy.md:238](../chapters/03_struktura/03-06_blok_shemy.md) | `Если Температура > 30 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/03_struktura/03-06_blok_shemy.md:272](../chapters/03_struktura/03-06_blok_shemy.md) | `Счётчик = 1;` | исполняется |
...
| [chapters/04_patterny/04-01_chto_takoe_pattern.md:92](../chapters/04_patterny/04-01_chto_takoe_pattern.md) | `Итого = 0;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-01_chto_takoe_pattern.md:141](../chapters/04_patterny/04-01_chto_takoe_pattern.md) | `НайденТовар = Ложь;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-01_chto_takoe_pattern.md:169](../chapters/04_patterny/04-01_chto_takoe_pattern.md) | `Сумма = 0;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-01_chto_takoe_pattern.md:191](../chapters/04_patterny/04-01_chto_takoe_pattern.md) | `Количество = 0;` | исполняется — рядом лежит вариант с точками с запятой |
...
| [chapters/04_patterny/04-02_poisk_elementa.md:134](../chapters/04_patterny/04-02_poisk_elementa.md) | `// Найти первый товар дороже 50 рублей` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-02_poisk_elementa.md:201](../chapters/04_patterny/04-02_poisk_elementa.md) | `ДоступныеТовары = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-02_poisk_elementa.md:252](../chapters/04_patterny/04-02_poisk_elementa.md) | `НайденныйТовар = Неопределено;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-02_poisk_elementa.md:295](../chapters/04_patterny/04-02_poisk_elementa.md) | `НайденнаяЦена = Неопределено;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-02_poisk_elementa.md:352](../chapters/04_patterny/04-02_poisk_elementa.md) | `НайденнаяЦена = Неопределено;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-02_poisk_elementa.md:391](../chapters/04_patterny/04-02_poisk_elementa.md) | `Товары = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-02_poisk_elementa.md:409](../chapters/04_patterny/04-02_poisk_elementa.md) | `ДешёвыеЦены = Новый Массив;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:35](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Товар Из Товары Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:56](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Цена Из Цены Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:79](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `ЦеныСоСкидкой = Новый Массив;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:120](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Цена Из Цены Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:147](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Цена Из Цены Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:180](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Цена Из Цены Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:236](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Товары = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:305](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Товар Из Товары Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:352](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Цены = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:378](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Цены = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-04_agregaciya.md:40](../chapters/04_patterny/04-04_agregaciya.md) | `Итого = 0;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-04_agregaciya.md:132](../chapters/04_patterny/04-04_agregaciya.md) | `Счётчик = 0;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-04_agregaciya.md:177](../chapters/04_patterny/04-04_agregaciya.md) | `Сумма = 0;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-04_agregaciya.md:238](../chapters/04_patterny/04-04_agregaciya.md) | `Цены = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-04_agregaciya.md:312](../chapters/04_patterny/04-04_agregaciya.md) | `Максимум = 0;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-04_agregaciya.md:351](../chapters/04_patterny/04-04_agregaciya.md) | `Цены = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-04_agregaciya.md:400](../chapters/04_patterny/04-04_agregaciya.md) | `Цены = Новый Массив;` | исполняется |
...
| [chapters/04_patterny/04-05_zashchitny_kod.md:76](../chapters/04_patterny/04-05_zashchitny_kod.md) | `НайденныйТовар = Неопределено;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-05_zashchitny_kod.md:133](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Если Количество <> 0 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-05_zashchitny_kod.md:206](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Цены = Новый Массив;` | исполняется |
| [chapters/04_patterny/04-05_zashchitny_kod.md:260](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Функция СреднееЗначение(Числа)` | исполняется |
| [chapters/04_patterny/04-05_zashchitny_kod.md:274](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Для каждого Товар Из Товары Цикл` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-05_zashchitny_kod.md:317](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Функция ПоказатьМаксимум(Цены)` | исполняется |
| [chapters/04_patterny/04-05_zashchitny_kod.md:343](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Функция СреднееЗначение(Числа)` | исполняется |
| [chapters/04_patterny/04-05_zashchitny_kod.md:382](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Процедура ПоказатьМаксимум(Цены)` | исполняется |
...
| [chapters/04_patterny/04-06_raspoznavanie.md:291](../chapters/04_patterny/04-06_raspoznavanie.md) | `МинимумНайден = Ложь;` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/04_patterny/04-06_raspoznavanie.md:332](../chapters/04_patterny/04-06_raspoznavanie.md) | `Функция НайтиСамоеДлинноеСлово(Слова)` | исполняется |
...
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:158](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `Сообщить("Сумма: " + Формат(Итого, "ЧДЦ=2"));       // два з` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:292](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `Товары = Новый Массив;` | исполняется |
...
| [chapters/07_kachestvo/07-05_chitaemost.md:69](../chapters/07_kachestvo/07-05_chitaemost.md) | `// Плохо: очевидно и без комментария` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/07_kachestvo/07-05_chitaemost.md:122](../chapters/07_kachestvo/07-05_chitaemost.md) | `// Плохо: одна большая процедура` | исполняется |
| [chapters/07_kachestvo/07-05_chitaemost.md:152](../chapters/07_kachestvo/07-05_chitaemost.md) | `// Плохо: что такое 0.05? что такое 50000?` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/07_kachestvo/07-05_chitaemost.md:194](../chapters/07_kachestvo/07-05_chitaemost.md) | `Процедура П(Д)` | исполняется |
| [chapters/07_kachestvo/07-05_chitaemost.md:209](../chapters/07_kachestvo/07-05_chitaemost.md) | `// Подсчитать суммарный объём проведённых поступлений за ука` | исполняется |
| [chapters/07_kachestvo/07-05_chitaemost.md:271](../chapters/07_kachestvo/07-05_chitaemost.md) | `// (а)` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/07_kachestvo/07-05_chitaemost.md:307](../chapters/07_kachestvo/07-05_chitaemost.md) | `Процедура ОбработкаЗаказа(ЗаказСсылка)` | исполняется |
| [chapters/07_kachestvo/07-05_chitaemost.md:334](../chapters/07_kachestvo/07-05_chitaemost.md) | `Если КатегорияКлиента = "VIP" И СуммаЗаказа > 100000 Тогда` | исполняется — рядом лежит вариант с точками с запятой |
| [chapters/07_kachestvo/07-05_chitaemost.md:391](../chapters/07_kachestvo/07-05_chitaemost.md) | `Функция ЗаказЯвляетсяКорректным(ЗаказСсылка)` | исполняется |
| [chapters/07_kachestvo/07-05_chitaemost.md:427](../chapters/07_kachestvo/07-05_chitaemost.md) | `КатегорияVIP            = "VIP";` | исполняется — рядом лежит вариант с точками с запятой |
...
| [chapters/01_leksika/01-04_komanda_esli.md:444](../chapters/01_leksika/01-04_komanda_esli.md) | `а)  Если Цена > 1000 Сообщить("Дорого"); КонецЕсли;` | parser: Ожидалось «;», получено «)» |
...
| [chapters/01_leksika/01-05_chtenie_koda.md:74](../chapters/01_leksika/01-05_chtenie_koda.md) | `Если Цена > 1000 Тогда` | чистый язык, не хватает контекста: Цена |
| [chapters/01_leksika/01-05_chtenie_koda.md:254](../chapters/01_leksika/01-05_chtenie_koda.md) | `// Здесь начинается расчёт скидки` | parser: Ожидалось «;», получено «ИначеЕсли» |
| [chapters/01_leksika/01-05_chtenie_koda.md:453](../chapters/01_leksika/01-05_chtenie_koda.md) | `Скидка = 0` | parser: Ожидалось «;», получено «Если» |
...
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:220](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Если Возраст < 18 Тогда` | parser: Ожидалось «;», получено «eof» |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:292](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `СтоимостьПокупки = 3500` | parser: Ожидалось «;», получено «ПостоянныйКлиент» |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:438](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `А = 5` | parser: Ожидалось «;», получено «Б» |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:449](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Возраст = 25` | parser: Ожидалось «;», получено «Если» |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:460](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `Сумма = 1500` | parser: Ожидалось «;», получено «ПроцентСкидки» |
| [chapters/01_leksika/01-06_vosstanovlenie_koda.md:474](../chapters/01_leksika/01-06_vosstanovlenie_koda.md) | `ОстатокРучек = 7` | parser: Ожидалось «;», получено «ОстатокКарандашей» |
...
| [chapters/02_semantika/02-02_tipy_znacheniy.md:169](../chapters/02_semantika/02-02_tipy_znacheniy.md) | `// Скидка действует только в выходные постоянным клиентам` | чистый язык, не хватает контекста: ЭтоПостоянныйКлиент |
...
| [chapters/03_struktura/03-01_struktura_programmy.md:115](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если А > 0 Тогда` | чистый язык, не хватает контекста: А |
| [chapters/03_struktura/03-01_struktura_programmy.md:131](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если А > 0 И Б > 0 И В > 0 И Г > 0 Тогда` | чистый язык, не хватает контекста: А |
| [chapters/03_struktura/03-01_struktura_programmy.md:145](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если ВозрастКлиента >= 18 И НаличиеПаспорта Тогда` | parser: Неожиданный токен «.» |
| [chapters/03_struktura/03-01_struktura_programmy.md:171](../chapters/03_struktura/03-01_struktura_programmy.md) | `КлиентДопущен = ВозрастКлиента >= 18 ` | parser: Неожиданный токен «.» |
| [chapters/03_struktura/03-01_struktura_programmy.md:315](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если НЕ ЗакрытоНаУчёт И ЕстьВНаличии ИЛИ ЭтоПодЗаказ Тогда` | чистый язык, не хватает контекста: ЗакрытоНаУчёт |
| [chapters/03_struktura/03-01_struktura_programmy.md:329](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если ВозрастКлиента >= 18 И НаличиеПаспорта И НетПросроченны` | чистый язык, не хватает контекста: ВозрастКлиента |
| [chapters/03_struktura/03-01_struktura_programmy.md:392](../chapters/03_struktura/03-01_struktura_programmy.md) | `Если (НЕ ЗакрытоНаУчёт И ЕстьВНаличии) ИЛИ ЭтоПодЗаказ Тогда` | чистый язык, не хватает контекста: ЗакрытоНаУчёт |
| [chapters/03_struktura/03-01_struktura_programmy.md:412](../chapters/03_struktura/03-01_struktura_programmy.md) | `КлиентДопущен = ВозрастКлиента >= 18 ` | чистый язык, не хватает контекста: ВозрастКлиента |
...
| [chapters/03_struktura/03-05_parametry_podrobno.md:111](../chapters/03_struktura/03-05_parametry_podrobno.md) | `КурсВалюты = 92;` | чистый язык, не хватает контекста: КурсВалюты |
...
| [chapters/03_struktura/03-05_parametry_podrobno.md:173](../chapters/03_struktura/03-05_parametry_podrobno.md) | `КурсДоставки = 150;` | чистый язык, не хватает контекста: КурсДоставки |
| [chapters/04_patterny/04-02_poisk_elementa.md:48](../chapters/04_patterny/04-02_poisk_elementa.md) | `Для каждого Элемент Из Коллекция Цикл` | чистый язык, не хватает контекста: Коллекция |
| [chapters/04_patterny/04-02_poisk_elementa.md:165](../chapters/04_patterny/04-02_poisk_elementa.md) | `// Найти товар, название которого начинается с "Кар"` | чистый язык, не хватает контекста: Товары |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:15](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Элемент Из Коллекция Цикл` | чистый язык, не хватает контекста: Коллекция |
| [chapters/04_patterny/04-04_agregaciya.md:83](../chapters/04_patterny/04-04_agregaciya.md) | `МаксимумНайден = Ложь;` | чистый язык, не хватает контекста: Коллекция |
| [chapters/04_patterny/04-04_agregaciya.md:222](../chapters/04_patterny/04-04_agregaciya.md) | `Задача       Инициализация   Обновление в цикле` | lexer: Неизвестный символ «─» |
| [chapters/04_patterny/04-05_zashchitny_kod.md:33](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Если Коллекция.Количество() = 0 Тогда` | чистый язык, не хватает контекста: Коллекция |
| [chapters/04_patterny/04-05_zashchitny_kod.md:185](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Функция КоллекцияНеПуста(Коллекция)` | runtime: У значения типа «Неопределено» нет методов |
| [chapters/04_patterny/04-05_zashchitny_kod.md:369](../chapters/04_patterny/04-05_zashchitny_kod.md) | `Если НайденнаяЦена = Неопределено Тогда` | чистый язык, не хватает контекста: НайденнаяЦена |
| [chapters/04_patterny/04-06_raspoznavanie.md:39](../chapters/04_patterny/04-06_raspoznavanie.md) | `Сумма = 0;` | чистый язык, не хватает контекста: Данные |
...
| [chapters/04_patterny/04-06_raspoznavanie.md:198](../chapters/04_patterny/04-06_raspoznavanie.md) | `ПервоеЧётное = Неопределено;` | чистый язык, не хватает контекста: Числа |
| [chapters/04_patterny/04-06_raspoznavanie.md:220](../chapters/04_patterny/04-06_raspoznavanie.md) | `Если Слова.Количество() = 0 Тогда` | чистый язык, не хватает контекста: Слова |
| [chapters/05_idiomy/05-01_obekty_svoystva_metody.md:33](../chapters/05_idiomy/05-01_obekty_svoystva_metody.md) | `Сообщить(Документ.Номер);    // прочитать свойство Номер` | чистый язык, не хватает контекста: Документ |
| [chapters/05_idiomy/05-01_obekty_svoystva_metody.md:62](../chapters/05_idiomy/05-01_obekty_svoystva_metody.md) | `Массив.Добавить("Ручка");           // процедура: добавляет,` | чистый язык, не хватает контекста: Массив |
...
| [chapters/05_idiomy/05-01_obekty_svoystva_metody.md:163](../chapters/05_idiomy/05-01_obekty_svoystva_metody.md) | `// Читаем свойства заказа` | чистый язык, не хватает контекста: Заказ |
| [chapters/05_idiomy/05-01_obekty_svoystva_metody.md:221](../chapters/05_idiomy/05-01_obekty_svoystva_metody.md) | `Сообщить(Документ.Организация.ИНН);` | чистый язык, не хватает контекста: Документ |
...
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:154](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `// Предполагаем, что Документ уже получен (как — в § 5.4)` | чистый язык, не хватает контекста: Документ |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:201](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `ПоложительныхСтрок = 0;` | чистый язык, не хватает контекста: Документ |
...
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:180](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Сообщить(Документ.Склад.Ответственный.Наименование);` | чистый язык, не хватает контекста: Документ |
...
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:108](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `Если ЗначениеЗаполнено(Документ.Склад) Тогда` | чистый язык, не хватает контекста: Документ |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:124](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `НовыйДокумент.Дата = ТекущаяДата();` | чистый язык, не хватает контекста: НовыйДокумент |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:234](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `// (а)` | чистый язык, не хватает контекста: Документ |
...
| [chapters/07_kachestvo/07-03_zashchitnyy_kod.md:55](../chapters/07_kachestvo/07-03_zashchitnyy_kod.md) | `Если НЕ ЗначениеЗаполнено(ДокументСсылка) Тогда` | чистый язык, не хватает контекста: ДокументСсылка |
| [chapters/07_kachestvo/07-03_zashchitnyy_kod.md:63](../chapters/07_kachestvo/07-03_zashchitnyy_kod.md) | `Если КоличествоДней <= 0 Тогда` | чистый язык, не хватает контекста: КоличествоДней |
| [chapters/07_kachestvo/07-03_zashchitnyy_kod.md:71](../chapters/07_kachestvo/07-03_zashchitnyy_kod.md) | `Если НЕ ЗначениеЗаполнено(НаименованиеТовара) Тогда` | чистый язык, не хватает контекста: НаименованиеТовара |
| [chapters/07_kachestvo/07-03_zashchitnyy_kod.md:79](../chapters/07_kachestvo/07-03_zashchitnyy_kod.md) | `Если Документ.Товары.Количество() = 0 Тогда` | чистый язык, не хватает контекста: Документ |
...
| [chapters/09_zavershenie/09-01_kontrolnaya_zadacha.md:197](../chapters/09_zavershenie/09-01_kontrolnaya_zadacha.md) | `Если ПроцентИзменения < -50 Тогда` | чистый язык, не хватает контекста: ПроцентИзменения |
...
| [chapters/05_idiomy/05-01_obekty_svoystva_metody.md:40](../chapters/05_idiomy/05-01_obekty_svoystva_metody.md) | `Объект.Комментарий = "Срочно"; // записать в свойство` | платформенный объект: Объект |
| [chapters/05_idiomy/05-01_obekty_svoystva_metody.md:52](../chapters/05_idiomy/05-01_obekty_svoystva_metody.md) | `Объект.Записать();           // метод без аргументов` | платформенный объект: Объект |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:32](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `// Найти элемент справочника по наименованию` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:53](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Ручка` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:75](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Ручка` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:93](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Выборка = Справочники.Номенклатура.Выбрать();` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:110](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `НазваниеТовара = "Тетрадь";` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:157](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Выборка = Документы.РеализацияТоваров.Выбрать();` | платформенный объект: Документы |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:174](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Линей` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:191](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Ссылка = Справочники.Контрагенты.НайтиПоНаименованию("ООО Ро` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-02_dostup_k_dannym.md:218](../chapters/05_idiomy/05-02_dostup_k_dannym.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Линей` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:50](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `Сообщить(Объект.Товары.Количество()); // сколько строк в таб` | платформенный объект: Объект |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:62](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `Для каждого Строка Из Объект.Товары Цикл` | платформенный объект: Объект |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:81](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `ИтогоСумма = 0;` | платформенный объект: Объект |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:93](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `СтрокаМаксимума = Неопределено;` | платформенный объект: Объект |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:138](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `НоваяСтрока = Объект.Товары.Добавить();` | платформенный объект: Объект |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:235](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `Для каждого Строка Из Объект.Товары Цикл` | платформенный объект: Объект |
| [chapters/05_idiomy/05-03_tablychnye_chasti.md:247](../chapters/05_idiomy/05-03_tablychnye_chasti.md) | `НоваяСтрока = Объект.Услуги.Добавить();` | платформенный объект: Объект |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:61](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Ручка` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:72](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Объект = Ссылка.ПолучитьОбъект();` | платформенный объект: Ссылка |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:88](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `// Способ 1: через ЗначениеЗаполнено` | платформенный объект: Ссылка |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:108](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `// Сохранить ссылку в переменную` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:129](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Ссылка = Документы.РеализацияТоваров.НайтиПоНомеру("РТ-00004` | платформенный объект: Документы |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:190](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Ссылка = Справочники.Контрагенты.НайтиПоНаименованию("Несуще` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:228](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Ссылка = Справочники.Контрагенты.НайтиПоНаименованию("Несуще` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:244](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Сообщить(Ссылка.Наименование);   // чтение — ссылки достаточ` | платформенный объект: Ссылка |
| [chapters/05_idiomy/05-04_chto_takoe_ssylka.md:250](../chapters/05_idiomy/05-04_chto_takoe_ssylka.md) | `Объект = Ссылка.ПолучитьОбъект();` | платформенный объект: Ссылка |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:47](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Ручка` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:69](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `Выборка = Справочники.Номенклатура.Выбрать();` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:86](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `// Создать новый элемент справочника` | платформенный объект: Справочники |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:180](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `// 1. Найти документ` | платформенный объект: Документы |
| [chapters/05_idiomy/05-05_tipichnye_oboroty.md:280](../chapters/05_idiomy/05-05_tipichnye_oboroty.md) | `НовыйТовар = Справочники.Номенклатура.СоздатьЭлемент();` | платформенный объект: Справочники |
| [chapters/06_kontekst/06-02_dokumenty_kak_sobytiya.md:78](../chapters/06_kontekst/06-02_dokumenty_kak_sobytiya.md) | `Ссылка = Документы.ПоступлениеТоваров.НайтиПоНомеру("ПТ-0000` | платформенный объект: Документы |
| [chapters/06_kontekst/06-02_dokumenty_kak_sobytiya.md:150](../chapters/06_kontekst/06-02_dokumenty_kak_sobytiya.md) | `Ссылка = Документы.РеализацияТоваров.НайтиПоНомеру("РТ-00002` | платформенный объект: Документы |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:37](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `// Просто сохранить документ (без проведения)` | платформенный объект: Документы |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:68](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `Объект = Ссылка.ПолучитьОбъект();` | платформенный объект: Ссылка |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:85](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `// Найти все документы за период и провести их` | платформенный объект: Документы |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:114](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `// Шаг 3: запись (без проведения)` | платформенный объект: Объект |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:160](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `Ссылка = Документы.РеализацияТоваров.НайтиПоНомеру("РТ-00000` | платформенный объект: Документы |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:199](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `Ссылка = Документы.ПоступлениеТоваров.НайтиПоНомеру("ПТ-0000` | платформенный объект: Документы |
| [chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md:222](../chapters/06_kontekst/06-03_zhiznennyy_tsikl_dokumenta.md) | `Ссылка = Документы.РеализацияТоваров.НайтиПоНомеру("РТ-00002` | платформенный объект: Документы |
| [chapters/06_kontekst/06-05_perevod_zadacha_kod.md:61](../chapters/06_kontekst/06-05_perevod_zadacha_kod.md) | `Ссылка = Справочники.Контрагенты.НайтиПоНаименованию("ООО Ст` | платформенный объект: Справочники |
| [chapters/06_kontekst/06-05_perevod_zadacha_kod.md:103](../chapters/06_kontekst/06-05_perevod_zadacha_kod.md) | `// (1)` | платформенный объект: Справочники |
| [chapters/06_kontekst/06-05_perevod_zadacha_kod.md:245](../chapters/06_kontekst/06-05_perevod_zadacha_kod.md) | `Счётчик = 0;` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-01_chto_takoe_khoroshiy_kod.md:73](../chapters/07_kachestvo/07-01_chto_takoe_khoroshiy_kod.md) | `П = 0;` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-02_obrabotka_oshibok.md:62](../chapters/07_kachestvo/07-02_obrabotka_oshibok.md) | `Ссылка = Документы.ПоступлениеТоваров.НайтиПоНомеру("ПТ-0000` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-02_obrabotka_oshibok.md:91](../chapters/07_kachestvo/07-02_obrabotka_oshibok.md) | `// Правильно: пустую ссылку проверяем до операции` | платформенный объект: Ссылка |
| [chapters/07_kachestvo/07-02_obrabotka_oshibok.md:196](../chapters/07_kachestvo/07-02_obrabotka_oshibok.md) | `Ссылка = Документы.РеализацияТоваров.НайтиПоНомеру("РТ-00009` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-02_obrabotka_oshibok.md:218](../chapters/07_kachestvo/07-02_obrabotka_oshibok.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Ручка` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-02_obrabotka_oshibok.md:247](../chapters/07_kachestvo/07-02_obrabotka_oshibok.md) | `Ссылка = Справочники.Номенклатура.НайтиПоНаименованию("Ручка` | платформенный объект: Справочники |
...
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:27](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `// Медленно: 1000 объектов = 1000 обращений к базе` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:38](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `// Быстро: читаем атрибуты напрямую из выборки` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:54](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `// Медленно: каждый товар — отдельная транзакция` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:74](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `// Медленно: перебираем все документы за все годы,` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:87](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `// Быстрее: выборка уже ограничена периодом` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:105](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `// Медленно: для каждого контрагента перебираем все документ` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:140](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `Выборка = Справочники.Номенклатура.Выбрать();` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:155](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `Выборка = Справочники.Номенклатура.Выбрать();` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:196](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `Выборка = Документы.ПоступлениеТоваров.Выбрать();` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:224](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `ИтогоСумма = 0;` | платформенный объект: Документы |
| [chapters/07_kachestvo/07-04_proizvoditelnost.md:248](../chapters/07_kachestvo/07-04_proizvoditelnost.md) | `НачалоГода = НачалоГода(ТекущаяДата());` | платформенный объект: Документы |
...
| [chapters/07_kachestvo/07-05_chitaemost.md:255](../chapters/07_kachestvo/07-05_chitaemost.md) | `Н = 0;` | платформенный объект: Справочники |
| [chapters/07_kachestvo/07-05_chitaemost.md:365](../chapters/07_kachestvo/07-05_chitaemost.md) | `КоличествоДорогихТоваров = 0;` | платформенный объект: Справочники |
| [chapters/08_sistema/08-01_put_dannykh.md:231](../chapters/08_sistema/08-01_put_dannykh.md) | `Движения.ТоварыНаСкладах.Записывать = Истина;` | платформенный объект: Движения |
| [chapters/08_sistema/08-02_moduli.md:54](../chapters/08_sistema/08-02_moduli.md) | `// Это вызов метода модуля менеджера документа:` | платформенный объект: Документы |
| [chapters/08_sistema/08-02_moduli.md:161](../chapters/08_sistema/08-02_moduli.md) | `// Строка 1` | платформенный объект: Справочники |
| [chapters/08_sistema/08-02_moduli.md:207](../chapters/08_sistema/08-02_moduli.md) | `// Строка 1: НайтиПоНаименованию — метод модуля менеджера сп` | платформенный объект: Справочники |
| [chapters/08_sistema/08-03_karta_obyektov.md:145](../chapters/08_sistema/08-03_karta_obyektov.md) | `Курс = РегистрыСведений.КурсыВалют.ПолучитьПоследнее(Текущая` | платформенный объект: РегистрыСведений |
...
| [chapters/01_leksika/01-04_komanda_esli.md:255](../chapters/01_leksika/01-04_komanda_esli.md) | `Если <условие 1> Тогда` | плейсхолдеры в угловых скобках |
| [chapters/01_leksika/01-04_komanda_esli.md:403](../chapters/01_leksika/01-04_komanda_esli.md) | `А = 5 < 7` | плейсхолдеры в угловых скобках |
| [chapters/01_leksika/01-04_komanda_esli.md:481](../chapters/01_leksika/01-04_komanda_esli.md) | `А = 5 < 7              →  Истина  (5 действительно меньше 7)` | плейсхолдеры в угловых скобках |
...
| [chapters/04_patterny/04-02_poisk_elementa.md:184](../chapters/04_patterny/04-02_poisk_elementa.md) | `НайденныеТовары = Новый Массив;` | плейсхолдеры в угловых скобках |
| [chapters/04_patterny/04-03_perebor_i_obrabotka.md:108](../chapters/04_patterny/04-03_perebor_i_obrabotka.md) | `Для каждого Элемент Из Коллекция Цикл` | плейсхолдеры в угловых скобках |
...
| [chapters/04_patterny/04-04_agregaciya.md:119](../chapters/04_patterny/04-04_agregaciya.md) | `Счётчик = 0;` | плейсхолдеры в угловых скобках |
